object frmFacturasAccess: TfrmFacturasAccess
  Left = 220
  Top = 150
  Width = 748
  Height = 559
  Caption = 'Facturación desde el programa de Access'
  Color = clBtnFace
  ...
  object JAMPanel1: TJAMPanel
    ...
    object DBNavigator1: TDBNavigator
      ...
      Width = 738
      Height = 25
      DataSource = dmFacturasAccess.dsVentas
  ...
  object JAMPanel2: TJAMPanel
    ...
    object DBGrid2: TDBGrid
      ...
      Height = 86
      Align = alClient
      DataSource = dmFacturasAccess.dsClientes
      Options = [dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgRowSelect, dgConfirmDelete, dgCancelOnExit]
      TabOrder = 1
      TitleFont.Charset = DEFAULT_CHARSET
      TitleFont.Color = clWindowText
  ...
  object JAMPanel3: TJAMPanel
    ...
    object DBGrid3: TDBGrid
      ...
      Height = 104
      Align = alClient
      DataSource = dmFacturasAccess.dsProductos
      Options = [dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgRowSelect, dgConfirmDelete, dgCancelOnExit]
      TabOrder = 1
      TitleFont.Charset = DEFAULT_CHARSET
      TitleFont.Color = clWindowText
  ...
  object JAMPanel4: TJAMPanel
    ...
    object btnFacturar: TButton
      ...
      Width = 129
      Height = 25
      Caption = 'Facturar esta operación'
      TabOrder = 0
    end
  end
  object mnuPrincipal: TMainMenu
    ...
    object mnuAbrir: TMenuItem
      Caption = 'Abrir la base de datos'
